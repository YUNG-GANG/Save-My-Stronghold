...
//        super.setBlockState(worldIn, blockstateIn, x, y, z, MapGenSafeStronghold.sStart._boundingBox);
        ...
        if (boundingboxIn.isVecInside(blockpos)) {
            ...
            if (this._mirror != Mirror.NONE) {
                blockstateIn = blockstateIn.withMirror(this._mirror);
            }

            if (this._rotation != Rotation.NONE) {
                blockstateIn = blockstateIn.withRotation(this._rotation);
            }
